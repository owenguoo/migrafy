    ...
    <Layout>
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-[#6a6a6a]">Connect with other immigrants and build your network</p>
        </div>
        <div className="flex gap-3">
          <div className="relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#6a6a6a]" size={16} />
            <input
              type="text"
      ...
      <div className="border border-[#d9e0e7] rounded-lg p-6 mb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border border-[#d9e0e7] rounded-lg p-4">
            <div className="flex gap-4 mb-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mb-1">
                  <span className="bg-[#d9e0e7] text-[#6a6a6a] text-xs px-2 py-0.5 rounded">Interest-based</span>
            ...
            <Button className="w-full bg-[#2273ce] hover:bg-[#2273ce]/90">Join Community</Button>
          </div>
          ...
          <div className="border border-[#d9e0e7] rounded-lg p-4">
            <div className="flex gap-4 mb-3">
              ...
              <div>
                <h3 className="font-medium mb-1">Retail & Customer Service Network</h3>
                <div className="flex items-center gap-2 mb-1">
                  <span className="bg-[#d9e0e7] text-[#6a6a6a] text-xs px-2 py-0.5 rounded">Industry</span>
          ...
          <div className="border border-[#d9e0e7] rounded-lg p-4">
            <div className="flex gap-4 mb-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mb-1">
                  <span className="bg-[#d9e0e7] text-[#6a6a6a] text-xs px-2 py-0.5 rounded">Language</span>
                  <span className="text-xs text-[#6a6a6a]">128 members</span>
                </div>
                <p className="text-xs text-[#6a6a6a]">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
          ...
          <div className="border border-[#d9e0e7] rounded-lg p-4">
            <div className="flex gap-4 mb-3">
              ...
              <div>
                <h3 className="font-medium mb-1">Community</h3>
                <div className="flex items-center gap-2 mb-1">
                  <span className="bg-[#d9e0e7] text-[#6a6a6a] text-xs px-2 py-0.5 rounded">Country-based</span>
                  <span className="text-xs text-[#6a6a6a]">128 members</span>
                </div>
                <p className="text-xs text-[#6a6a6a]">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs text-[#6a6a6a]">160 posts this week</span>
            </div>
            <Button className="w-full bg-[#2273ce] hover:bg-[#2273ce]/90">Join Community</Button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="border border-[#d9e0e7] rounded-lg p-6 md:col-span-2">
          <h3 className="text-lg font-semibold mb-2">Recommended Communities</h3>
          <p className="text-sm text-[#6a6a6a] mb-4">Based on your profile and interests</p>
          ...
          <div className="space-y-4">
            ...
            <div className="border border-[#d9e0e7] rounded-lg p-4 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6a6a6a]">320 members • 87 posts this week</p>
                </div>
              </div>
              <Button className="bg-[#2273ce] hover:bg-[#2273ce]/90 text-xs py-1 h-8 px-4">Join</Button>
            </div>
            ...
            <div className="border border-[#d9e0e7] rounded-lg p-4 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-medium">Painting - Claude Monet Inspired</h4>
                  <p className="text-xs text-[#6a6a6a]">156 members • 25 posts this week</p>
                </div>
              </div>
              <Button className="bg-[#2273ce] hover:bg-[#2273ce]/90 text-xs py-1 h-8 px-4">Join</Button>
            </div>
            ...
            <div className="border border-[#d9e0e7] rounded-lg p-4 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6a6a6a]">265 members • 20 posts this week</p>
                </div>
              </div>
              <Button className="bg-[#2273ce] hover:bg-[#2273ce]/90 text-xs py-1 h-8 px-4">Join</Button>
            </div>
        ...
        <div className="border border-[#d9e0e7] rounded-lg p-6">
          ...
          <p className="text-sm text-[#6a6a6a] mb-4">Events from your communities</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-sm">Toronto Newcomers Meetup</h4>
                <p className="text-xs text-[#6a6a6a] mb-2">Christie Pits Park • 10:00 AM</p>
                <button className="w-full text-xs border border-[#d9e0e7] rounded py-1 text-[#2273ce]">Register</button>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-sm">Resume Workshop • Spanish</h4>
