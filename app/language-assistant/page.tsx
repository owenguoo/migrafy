...
import { ArrowLeft, Play, Settings, Mic, Video, BookOpen, Info } from "lucide-react"
    ...
    <Layout>
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-2">
          <Link href="/language-learning" className="text-[#6a6a6a] hover:text-[#2273ce]">
            <ArrowLeft size={24} />
          </Link>
      ...
      <div className="flex border-b border-[#d9e0e7] mb-6">
        <button className="px-6 py-3 text-[#2273ce] border-b-2 border-[#2273ce] font-medium">Free Practice</button>
        <button className="px-6 py-3 text-[#6a6a6a]">Job Interview</button>
        <button className="px-6 py-3 text-[#6a6a6a]">Workplace Conversation</button>
      </div>
      ...
      <div className="border border-[#d9e0e7] rounded-lg p-8 bg-[#f5f7fa] mb-6">
        <div className="flex flex-col items-center">
          ...
          <Button className="bg-[#2273ce] hover:bg-[#2273ce]/90 mb-6">Practice Live with AI</Button>
        ...
        <div className="mt-8 flex items-center gap-2 text-sm text-[#6a6a6a]">
          <BookOpen size={16} />
          <span>Suggested Topics: Customer inquiries, Return policies, Product information</span>
        </div>
      </div>
            ...
            <div>
              <p className="font-medium">
                ...
                <span className="font-normal">
                  Hello! I'm your language learning assistant. How can I help you practice English for customer service
                  today?
                </span>
              </p>
            </div>
            ...
            <div>
              <p className="font-medium">
                ...
                <span className="font-normal text-[#2273ce]">
                  How would I help someone who wants to give back item, no receipt?
                </span>
              </p>
            </div>
        ...
        <div className="flex-1 border border-[#d9e0e7] rounded-lg p-6">
          ...
          <div className="space-y-4 mb-8">
            <div>
              ...
              <div className="h-2 bg-[#d9d9d9] rounded-full overflow-hidden">
                <div className="h-full bg-[#6cadf5] rounded-full" style={{ width: "72%" }}></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-[#d9d9d9] rounded-full overflow-hidden">
                <div className="h-full bg-[#6cadf5] rounded-full" style={{ width: "45%" }}></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-[#d9d9d9] rounded-full overflow-hidden">
                <div className="h-full bg-[#6cadf5] rounded-full" style={{ width: "89%" }}></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-2 bg-[#d9d9d9] rounded-full overflow-hidden">
                <div className="h-full bg-[#6cadf5] rounded-full" style={{ width: "65%" }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-2">
              <div className="w-6 h-6 rounded-full bg-[#ffebeb] flex items-center justify-center flex-shrink-0">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18 6L6 18" stroke="#b53030" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M6 6L18 18" stroke="#b53030" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <span className="text-sm text-[#b53030]">give back item no receipt</span>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-sm text-[#00a508]">return an item without a receipt</span>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-sm text-[#6a6a6a]">
                Being specific and descriptive provides more information and demonstrates better vocabulary.
              </span>
            </div>
          </div>
        </div>
